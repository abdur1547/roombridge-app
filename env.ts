...
const BUNDLE_IDS = {
  development: 'com.roombridge.development',
  preview: 'com.roombridge.preview',
  production: 'com.roombridge',
} as const;
...
const SCHEMES = {
  development: 'RoomBridge',
  preview: 'RoomBridge.preview',
  production: 'RoomBridge',
} as const;

const NAME = 'RoomBridge';
